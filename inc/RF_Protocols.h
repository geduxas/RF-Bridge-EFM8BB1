...
#if EFM8BB1_SUPPORT_TE44_PROTOCOL == 1
#define TE44
SI_SEGMENT_VARIABLE(PROTOCOL_BUCKETS(TE44)[], static uint16_t, SI_SEG_CODE) = { 540, 920 , 1900, 3830 };
SI_SEGMENT_VARIABLE(PROTOCOL_START(TE44)[], static uint8_t, SI_SEG_CODE) = { HIGH(0), LOW(3) };
SI_SEGMENT_VARIABLE(PROTOCOL_BIT0(TE44)[], static uint8_t, SI_SEG_CODE) = { HIGH(0), LOW(1) };
SI_SEGMENT_VARIABLE(PROTOCOL_BIT1(TE44)[], static uint8_t, SI_SEG_CODE) = { HIGH(0), LOW(2) };
#endif
...
SI_SEGMENT_VARIABLE(PROTOCOL_DATA[], static struct BUCKET_PROTOCOL_DATA, SI_SEG_CODE) =
{
		 ...
		 */
		{
			{ &PROTOCOL_BUCKETS(TE44), ARRAY_LENGTH(PROTOCOL_BUCKETS(TE44)) },
			{ &PROTOCOL_START(TE44), ARRAY_LENGTH(PROTOCOL_START(TE44)) },
			{ &PROTOCOL_BIT0(TE44), ARRAY_LENGTH(PROTOCOL_BIT0(TE44)) },
			{ &PROTOCOL_BIT1(TE44), ARRAY_LENGTH(PROTOCOL_BIT1(TE44)) },
			{ NULL, 0 },
			36
		},
};
